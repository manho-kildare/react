...
export default function UserOrCreateTest() {
  
  const headTexts = useOrCreate<string[]>('headTexts', () => ['No.', 'Name', 'Job Title', 'Email Adress']);
  ...
  return (
    <div className="mt-4">
      ...
      <div className="overflow-xauto mt-4 p-4">
