...
import { ValidatableInput, ValidatableInputMethods } from "../theme/daisyui/ValidatableInput";

export default function ValidateableInputTest() {
  ...
  const validateEmail = useCallback(() => {
    if (methodsRef.current) {
      ...
      if (valid) alert(`${valueOrErrorMessage}는 유효한 이일 주소입니다.`);
